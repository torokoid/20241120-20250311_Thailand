...
<h2><span class="yellow">メタバース「cluster」内のイベントで「雪の約束」by まいてゃさん<br>ダンサーの玖遠さんがトラブってみんなでステージダンスになりました</span></h2>
    ...
    <video controls width="640">
        <source src="https://torokoid.github.io/torokoid/20250226_chiangrai/2025-02-26 yukinoyakusoku by maitiya.mp4" type="video/mp4">
...
<!-- フッタ -->
<footer>
<p>Copyright 2025/03/15 alis @Tochigi,Japan</p>
</footer>
